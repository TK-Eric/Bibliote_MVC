using Base.Contexts;                  // Importa o DbContext do projeto (BbDbContext)
using Base.Interfaces;
using Base.Repostories;
using Base.Services;
...
builder.Services.AddDbContext<BbDbContext>(options =>
    options.UseSqlServer(                                          // Define SQL Server como banco de dados
        builder.Configuration.GetConnectionString("DefaultConection")  // Lê a connection string do appsettings.json
