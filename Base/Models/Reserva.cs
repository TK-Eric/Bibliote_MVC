...
using AspNetCoreGeneratedDocument;                     // ⚠️ Esse using parece desnecessário aqui — não há nada desse namespace sendo usado nesse arquivo
using Base.Models;
using Microsoft.Identity.Client;                       // ⚠️ Esse também parece desnecessário — é da lib de autenticação da Microsoft (MSAL), não relacionado a modelos
